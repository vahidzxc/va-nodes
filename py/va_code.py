...
from va_nodes.py.imagefunc import *
...
NODE_CLASS_MAPPINGS = {
    "va_code": EncodeBlindWaterMark,
    "va_decode": DecodeBlindWaterMark
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "va nodes: va code": "va code",
    "va nodes: va decode": "va decode"
}